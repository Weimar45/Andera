...
### [MG-RAST: Metagenomics Rapid Annotations using Subsystems Technology](http://metagenomics.anl.gov)

**MG-RAST** (**Metagenomics Rapid Annotations using Subsystems Technology**) es una herramienta integral para el procesamiento, análisis, compartición y difusión de conjuntos de datos metagenómicos. Como se destaca en ["The MG-RAST metagenomics database and portal in 2015"](https://doi.org/10.1093/nar/gkv1322), MG-RAST es un portal que alberga más de 200,000 conjuntos de datos y se actualiza constantemente, reflejando la creciente importancia de la metagenómica en diversas disciplinas científicas.

Este crecimiento exponencial en el volumen de datos manejados por MG-RAST, que ahora promedia 4 terabases por mes, ha impulsado el desarrollo de nuevas características y cambios significativos en el flujo de trabajo de análisis y las tecnologías utilizadas para escalar el flujo de trabajo hasta los niveles de rendimiento requeridos. Además, MG-RAST no solo permite el procesamiento y análisis de datos metagenómicos, sino que también facilita la integración de estos datos y análisis en herramientas de análisis de terceros populares o herramientas de alineación de secuencias. Esto proporciona a los investigadores una flexibilidad sin precedentes para explorar y entender sus datos.

La importancia de MG-RAST se extiende más allá de ser simplemente un recurso de datos. Como se destaca en ["phyloseq: An R Package for Reproducible Interactive Analysis and Graphics of Microbiome Census Data"](https://doi.org/10.1371/journal.pone.0061217) y ["Predictive functional profiling of microbial communities using 16S rRNA marker gene sequences"](https://doi.org/10.1038/nbt.2676), MG-RAST es una herramienta esencial para el estudio de microbiomas y la ecología microbiana. La capacidad de predecir la composición funcional de un metagenoma utilizando datos de marcadores genéticos y una base de datos de genomas de referencia es de gran importancia para entender la diversidad y funcionalidad de las comunidades microbianas.

Además, MG-RAST puede ser útil en la medicina traslacional, donde las comunidades microbianas y la dieta de los humanos se recrean en ratones gnotobióticos con el fin de estudiar el impacto de las diferentes floras y el huésped utilizando la metagenómica. Como se ilustra en ["The Effect of Diet on the Human Gut Microbiome: A Metagenomic Analysis in Humanized Gnotobiotic Mice"](https://doi.org/10.1126/scitranslmed.3000322), este enfoque ha permitido, por ejemplo, analizar el efecto de la dieta en el microbioma humano.