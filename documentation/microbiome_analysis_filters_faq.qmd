...
- **Filtrado por variabilidad**: Este tipo de filtrado implica eliminar las OTUs que tienen una variabilidad baja o alta en su abundancia entre las muestras. Esta categoría de filtrado puede ser de importancia para eliminar las OTUs que son constantes o muy variables entre las muestras, ya que podrían no ser informativas para los análisis posteriores.
