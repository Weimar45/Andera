...
4. Por lo general, es muy difícil determinar, sólo a partir de las 
mediciones de la abundancia relativa, si estas asociaciones negativas
representan una verdadera anticorrelación (por ejemplo, un organismo
que supera a otro) o el crecimiento excesivo de un organismo mientras
que el resto de la población permanece invariable (lo que da lugar a
una correlación negativa debido a la composición de estos datos). ¿Por qué?
...
5. ¿Qué es el cálculo de disancias funcionales por Jaccard index of
non-shared COG families?
